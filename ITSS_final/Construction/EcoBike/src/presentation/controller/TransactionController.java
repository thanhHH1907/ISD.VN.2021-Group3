...
import data.repository.TransactionInfoRepositoryImpl;
...
import presentation.screen.payment.TransactionErrorScreenHandler;
...
public class TransactionController extends BaseController {
    private TransactionInfoRepositoryInterface transactionInfoRepository = new TransactionInfoRepositoryImpl();
    /**
    ...
    public void newTransactionDB(int idInvoice, Card card, TransactionInfo transactionResult) throws SQLException {
        transactionInfoRepository.newTransactionDB(idInvoice, card,transactionResult);
    }
